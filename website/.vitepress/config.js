...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: 'Copyright © 2020-present <a class="link" href="//rovelstars.com">Rovel Stars</a>'
    },
    nav: [
      { text: 'Home', link: '/' },
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: 'Create new project', link: '/docs/getting-started/create-project' },
        ]
      },
      {
        text: 'Basics',
      ...
      },
      {
        text: 'Packages',
        items: [
          { text: '@reejs/imports', link: '/docs/packages/imports' },
        ]
      }
    ],
